...
#
# For Dependabot's own pip PRs, .github/workflows/dependabot.yml runs this
# script and pushes the result (with a PAT, because a GITHUB_TOKEN push starts
# no workflow runs). Run it by hand after editing a .in file yourself, or when
# that workflow's RELOCK_TOKEN secret is missing.
#
# Usage:
